...
class Alamat extends REST_Controller {
 ...
 private $folder_upload = 'uploads/';
  ...
  function myAlamat_post(){
    ...
    {
      $id_alamat = $this->post('id_alamat');
      $alamatDisable = $this->db->query("SELECT tempat_sewa.id_alamat FROM tempat_sewa JOIN alamat ON alamat.id_alamat=tempat_sewa.id_alamat WHERE tempat_sewa.id_alamat='$id_alamat'")->result();
